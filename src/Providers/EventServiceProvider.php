...
class EventServiceProvider extends ServiceProvider
{
    ...
    {
        $cacheKey = 's3_ru_events_and_observers';
    ...
    protected function customDiscoverEvents()
    {
        ...
        $namespace = 'Innoboxrr\S3ResumableUploads\Http\Events\\';
    ...
    protected function customDiscoverObservers()
    {
        ...
        $namespaceModel = 'Innoboxrr\S3ResumableUploads\Models\\';
        $namespaceObserver = 'Innoboxrr\S3ResumableUploads\Observers\\';
